		...
		<fieldset id="wc-<?php echo esc_attr( $this->id ); ?>-cc-form" class="wc-credit-card-form wc-payment-form" style="background:transparent;">
			...
			<?php } else { ?>
				<div class="form-row form-row-wide">
					<label for="stripe-card-element"><?php esc_html_e( 'Card Number', 'woocommerce-gateway-stripe' ); ?> </label>
				...
				<div class="form-row form-row-wide">
					<label for="stripe-cvc-element"><?php esc_html_e( 'CVC', 'woocommerce-gateway-stripe' ); ?> </label>
